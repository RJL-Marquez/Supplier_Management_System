...
const PAGE_MODULES: { key: PageModuleKey; label: string; description: string }[] = [
  ...
  { key: 'document-register', label: 'Document Register', description: 'Categorized compliance-document table across all partner companies' },
  { key: 'renew-documents', label: 'Renew Compliance Documents', description: 'Action permission: update document expiry dates/status in Partner Companies and the Document Register, without needing full Account Management access' },
